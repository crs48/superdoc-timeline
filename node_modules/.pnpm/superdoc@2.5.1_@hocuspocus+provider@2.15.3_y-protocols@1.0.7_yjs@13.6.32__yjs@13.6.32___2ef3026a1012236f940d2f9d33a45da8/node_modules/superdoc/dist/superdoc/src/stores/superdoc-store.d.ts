export const useSuperdocStore: import('pinia').StoreDefinition<"superdoc", Pick<{
    ...
    zoomMode: import('vue').Ref<any, any>;
    measurementUnit: import('vue').Ref<any, any>;
    viewportMetrics: import('vue').Ref<any, any>;
    documentScroll: {
        scrollTop: number;
        scrollLeft: number;
    };
    ...
    removeDocument: (documentId: string) => any | null;
    getPageBounds: (documentId: any, page: any) => {
        top: number;
    } | undefined;
}, "user" | "users" | "isReady" | "activeZoom" | "zoomMode" | "viewportMetrics" | "documents" | "pages" | "isInternal" | "commentsStore" | "documentBounds" | "documentUsers" | "measurementUnit" | "documentScroll" | "selectionPosition" | "activeSelection" | "modules">, Pick<{
    commentsStore: import('pinia').Store<"comments", Pick<{
        COMMENT_EVENTS: {
            readonly RESOLVED: "resolved";
            readonly NEW: "new";
...
}, "reset" | "init" | "setExceptionHandler" | "handlePageReady" | "getDocument" | "removeDocument" | "getPageBounds">>;
