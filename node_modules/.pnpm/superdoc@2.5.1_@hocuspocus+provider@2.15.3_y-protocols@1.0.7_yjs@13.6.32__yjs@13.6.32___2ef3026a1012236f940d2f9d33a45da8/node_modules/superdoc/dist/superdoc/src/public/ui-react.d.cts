...
export declare const useSuperDocTrackChanges: typeof import('./ui-react.js', { with: { "resolution-mode": "import" } }).useSuperDocTrackChanges;
export declare const useSuperDocUI: typeof import('./ui-react.js', { with: { "resolution-mode": "import" } }).useSuperDocUI;
export declare const useSuperDocZoom: typeof import('./ui-react.js', { with: { "resolution-mode": "import" } }).useSuperDocZoom;
