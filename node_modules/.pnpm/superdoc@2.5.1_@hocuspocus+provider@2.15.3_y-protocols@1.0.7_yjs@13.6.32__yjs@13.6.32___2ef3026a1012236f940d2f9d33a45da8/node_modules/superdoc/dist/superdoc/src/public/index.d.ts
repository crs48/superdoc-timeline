...
export declare const BlankDOCX: string;
...
export type { BlocksListResult } from '../../../document-api/src/index.js';
export type { BookmarkAddress } from '../core/types/index.js';
export type { BookmarkInfo } from '../../../document-api/src/index.js';
...
export type { ResolveRangeOutput } from '../../../document-api/src/index.js';
...
export type { SelectionInfo } from '../../../document-api/src/index.js';
...
export type { TextAddress } from '../../../document-api/src/index.js';
export type { TextSegment } from '../../../document-api/src/index.js';
export type { TextTarget } from '../../../document-api/src/index.js';
