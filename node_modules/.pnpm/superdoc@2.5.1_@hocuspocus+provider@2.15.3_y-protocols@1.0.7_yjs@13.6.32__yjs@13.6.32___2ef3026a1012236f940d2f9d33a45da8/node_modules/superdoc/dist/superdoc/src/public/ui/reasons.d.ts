 ...
 */
export declare const SUPERDOC_UI_REASONS: {
    ...
    readonly documentApiUnavailable: "document-api-unavailable";
    /** The document is in viewing / read-only mode, so mutating commands are blocked. */
    readonly documentReadonly: "document-readonly";
    ...
    readonly rangeSelectionRequired: "range-selection-required";
     ...
     */
    readonly searchUnavailable: "search-unavailable";
    /** The search pattern is an invalid or unsafe regular expression. */
    readonly searchInvalidPattern: "search-invalid-pattern";
    /**
     ...
     */
    readonly replaceUnsupported: "replace-unsupported";
    /**
     ...
     */
    readonly contentControlLocked: "content-control-locked";
};
/**
