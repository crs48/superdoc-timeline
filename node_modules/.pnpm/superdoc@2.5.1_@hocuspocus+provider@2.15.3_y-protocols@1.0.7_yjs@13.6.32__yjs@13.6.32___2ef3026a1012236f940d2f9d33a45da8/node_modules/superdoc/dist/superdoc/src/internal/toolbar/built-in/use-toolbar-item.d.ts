export function useToolbarItem(options: any): {
    ...
    nestedOptions: import('vue').Ref<never[], never[]>;
    ...
    parentItem: import('vue').Ref<null, null>;
    iconColor: import('vue').Ref<any, any>;
    hasCaret: import('vue').Ref<any, any>;
    splitButton: import('vue').Ref<boolean, boolean>;
    splitButtonCommand: any;
    ...
    childItem: import('vue').Ref<null, null>;
