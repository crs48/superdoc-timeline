import { DocumentInfo, MutationsApplyInput, MutationsPreviewInput, MutationsPreviewOutput, NodeAddress, PlanReceipt, QueryMatchInput, QueryMatchOutput, TextSelector, NodeSelector, Receipt, TextMutationReceipt, SDMutationReceipt, ExtractResult } from './types/index.js';
import { CommentsAdapter, CommentsApi } from './comments/comments.js';
import { DeleteInput } from './delete/delete.js';
import { FindAdapter } from './find/find.js';
import { SDFindInput, SDFindResult, SDGetInput, SDNodeResult } from './types/sd-envelope.js';
import { FormatApi, FormatRangeInput } from './format/format.js';
import { StylesAdapter, StylesApi } from './styles/index.js';
import { TemplatesAdapter, TemplatesApi } from './templates/index.js';
import { GetNodeAdapter, GetNodeByIdInput } from './get-node/get-node.js';
import { GetAdapter } from './get/get.js';
...
import { SelectionApi, SelectionAdapter } from './selection/selection.js';
import { ListsAdapter, ListsApi } from './lists/lists.js';
import { ReplaceInput } from './replace/replace.js';
import { CreateAdapter, CreateApi } from './create/create.js';
...
import { ParagraphsAdapter, ParagraphFormatApi, ParagraphStylesApi } from './paragraphs/paragraphs.js';
import { SectionsAdapter, SectionsApi } from './sections/sections.js';
import { HeaderFootersAdapter, HeaderFootersApi } from './header-footers/header-footers.js';
import { DocumentMutationResult } from './sections/sections.types.js';
import { ImagesAdapter, ImagesApi, CreateImageAdapter } from './images/images.js';
import { TocApi, TocAdapter } from './toc/toc.js';
import { HyperlinksApi, HyperlinksAdapter } from './hyperlinks/hyperlinks.js';
import { ContentControlsApi, ContentControlsAdapter, ContentControlsCreateAdapter } from './content-controls/content-controls.js';
import { BookmarksApi, BookmarksAdapter } from './bookmarks/bookmarks.js';
import { CustomXmlApi, CustomXmlAdapter } from './customXml/customXml.js';
import { AnchoredMetadataApi, AnchoredMetadataAdapter } from './metadata/anchored-metadata.js';
import { ProtectionApi, ProtectionAdapter } from './protection/protection.js';
import { PermissionRangesApi, PermissionRangesAdapter } from './permission-ranges/permission-ranges.js';
import { FootnotesApi, FootnotesAdapter } from './footnotes/footnotes.js';
import { ClipboardApi, ClipboardAdapter } from './clipboard/clipboard.js';
import { CrossRefsApi, CrossRefsAdapter } from './cross-refs/cross-refs.js';
import { IndexApi, IndexAdapter } from './index/index.js';
import { CaptionsApi, CaptionsAdapter } from './captions/captions.js';
import { FieldsApi, FieldsAdapter } from './fields/fields.js';
import { CitationsApi, CitationsAdapter } from './citations/citations.js';
import { AuthoritiesApi, AuthoritiesAdapter } from './authorities/authorities.js';
...
export type { SelectionMutationAdapter, SelectionMutationRequest, SelectionInsertRequest, } from './selection-mutation.js';
export type { RangeAnchor, DocumentEdgeAnchor, PointAnchor, RefBoundaryAnchor, ResolveRangeInput, ResolveRangeOutput, RangeBlockPreview, RangePreview, RangeResolverAdapter, ScrollIntoViewInput, ScrollIntoViewOutput, } from './ranges/index.js';
...
export { PROPERTY_REGISTRY, EXCLUDED_KEYS, ALLOWED_KEYS_BY_CHANNEL, getPropertyDefinition, toJsonSchema, buildPatchSchema, buildStateSchema, } from './styles/index.js';
export type { ValueSchema, MergeStrategy, PropertyDefinition, StylesAdapter, StylesApplyInput, StylesApplyRunInput, StylesApplyParagraphInput, StylesApplyOptions, StylesApplyReceipt, StylesBooleanState, StylesNumberState, StylesEnumState, StylesObjectState, StylesArrayState, StylesStateMap, StylesChannel, StylesRunPatch, StylesParagraphPatch, StylesTargetResolution, StylesApplyReceiptSuccess, StylesApplyReceiptFailure, NormalizedStylesApplyOptions, StyleCatalogView, StyleCatalogItemType, StyleCatalogFilterType, StyleProvenance, StyleCatalogDiagnosticSeverity, StyleSourcePartStatus, StyleCatalogUsageStatus, StyleCatalogPreviewStatus, StyleCatalogViewStatus, StyleCatalogItemVisibility, StyleCatalogItemUsage, StyleCatalogItemPreview, StyleCatalogItem, StyleCatalogDefaults, StyleCatalogDiagnostic, StyleCatalogSourceStatus, StylesGetCatalogInput, StylesGetCatalogResult, StylesGetCatalogAdapter, } from './styles/index.js';
export { STYLE_CATALOG_VIEWS, STYLE_CATALOG_FILTER_TYPES, executeStylesGetCatalog, validateStylesGetCatalogInput, } from './styles/index.js';
export type { TemplatesAdapter, TemplatesApi, TemplatesApplyInput, TemplatesApplyOptions, TemplatesApplySource, TemplatesApplySourcePath, TemplatesApplySourceBase64, TemplateBodyPolicy, TemplateScope, NormalizedTemplatesApplyOptions, TemplateScopeReport, TemplateSkipReason, TemplateScopeSkip, TemplateUnsupportedItem, TemplateChangeKind, TemplateChangedPart, TemplateIdMapping, TemplateApplyWarning, TemplatesApplySourceInfo, TemplatesApplyReceiptSuccess, TemplatesApplyFailureCode, TemplatesApplyReceiptFailure, TemplatesApplyReceipt, } from './templates/index.js';
export { executeTemplatesApply } from './templates/index.js';
export type { CreateAdapter, CreateApi } from './create/create.js';
export { executeCreateParagraph, executeCreateHeading, executeCreateTable, executeCreateSectionBreak, executeCreateTableOfContents, } from './create/create.js';
export type { TrackChangesAdapter, TrackChangesApi, TrackChangesGetInput, TrackChangesListInput, TrackChangesAcceptInput, TrackChangesRejectInput, TrackChangesAcceptAllInput, TrackChangesRejectAllInput, TrackChangesRangeInput, ReviewDecideInput, ReviewDecideRangeInput, ReviewDecideTarget, LegacyReviewDecideTarget, ReviewDecisionTarget, } from './track-changes/track-changes.js';
...
export { executeClipboardParse, executeClipboardInsert, executeClipboardSerializeSelection, } from './clipboard/clipboard.js';
...
export { PARAGRAPH_ALIGNMENTS, TAB_STOP_ALIGNMENTS, TAB_STOP_LEADERS, BORDER_SIDES, CLEAR_BORDER_SIDES, LINE_RULES, PARAGRAPH_DIRECTIONS, ALIGNMENT_POLICIES, } from './paragraphs/paragraphs.js';
...
export declare function createDocumentApi(adapters: DocumentApiAdapters): DocumentApi;
