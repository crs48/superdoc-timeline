import { BlockNavigationAddress, EntityAddress, SelectionTarget, TextAddress, TrackedChangeAddress } from './address.js';
...
export type TextMutationReceipt = (ReceiptSuccess & {
