...
import { TextAddress, TrackedChangeAddress, SelectionTarget, DeleteBehavior } from './address.js';
import { TextSelector, NodeSelector } from './query.js';
import { InsertStylePolicy, StylePolicy } from './style-policy.types.js';
...
export type MutationStep = TextRewriteStep | TextInsertStep | TextDeleteStep | StyleApplyStep | StructuralInsertStep | StructuralReplaceStep | AssertStep | DomainStep;
