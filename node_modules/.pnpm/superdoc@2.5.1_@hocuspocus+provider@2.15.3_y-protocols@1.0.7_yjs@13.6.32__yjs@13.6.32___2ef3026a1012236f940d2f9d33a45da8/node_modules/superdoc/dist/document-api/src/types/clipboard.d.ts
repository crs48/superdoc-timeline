...
export declare const SUPERDOC_V1_CLIPBOARD_MIME = "application/x-superdoc-slice";
export declare const SUPERDOC_V2_CLIPBOARD_FRAGMENT_KIND = "superdoc.clipboard.fragment";
export declare const SUPERDOC_V2_CLIPBOARD_FRAGMENT_VERSION = "v2.1";
export declare const SUPERDOC_V22_CLIPBOARD_FRAGMENT_VERSION = "v2.2";
export declare const MAX_V22_ASSET_DECODED_BYTES: number;
export declare const MAX_V22_TOTAL_DECODED_BYTES: number;
export declare const MAX_V22_ASSET_COUNT = 16;
export declare const MAX_V22_IMAGE_REF_COUNT = 64;
export declare const MAX_V22_PAYLOAD_BYTES: number;
export type ClipboardSourceKind = 'superdoc-v2-fragment' | 'superdoc-v1-slice' | 'html' | 'rtf' | 'image' | 'file' | 'plain-text' | 'empty' | 'unknown';
export type SDPasteUnsupportedReason = 'paste-empty' | 'paste-payload-too-large' | 'paste-depth-exceeded' | 'paste-source-unsupported' | 'paste-fragment-version-unsupported' | 'paste-no-faithful-representation' | 'paste-structure-unsupported' | 'paste-media-unsupported-type' | 'paste-media-bad-magic' | 'paste-media-too-large' | 'paste-tracked-structural-unsupported' | 'paste-cross-story-unsupported' | 'paste-target-unsupported' | 'paste-legacy-slice-unsupported' | 'paste-security-rejected';
...
export type ClipboardTarget = SelectionTarget | {
    kind: 'block';
    nodeId: string;
