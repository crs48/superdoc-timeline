...
export declare const OPERATION_REQUIRES_DOCUMENT_CONTEXT_MAP: Record<OperationId, boolean>;
/** Maps each operation to its expected-result description. */
export declare const OPERATION_EXPECTED_RESULT_MAP: Record<OperationId, string>;
/**
 ...
 */
export declare function getCommandMetadata(operationId: keyof typeof COMMAND_CATALOG): CommandStaticMetadata;
