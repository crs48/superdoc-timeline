...
export { createBundledActivation, deriveBundledActivation, FULLY_ACTIVE_BUNDLED, BASELINE_BUNDLED } from './activation.js';
export { setBundledFontAssetBase, getBundledFontAssetBase, DEFAULT_BUNDLED_FONT_BASE, markBundledPackPresent, isBundledPackPresent, __resetBundledPackPresent, } from './bundled.js';
export type { FontResolutionRecord, ResolvedFontEvidence, UsedFace } from './report.js';
...
export { FONT_OFFERINGS, getBuiltInToolbarFontOfferings, getDefaultFontOfferings, getDefaultFontFamilyOptions, fontOfferingStack, fontOfferingRenderStack, warnUnknownBundledSelection, getBundledFamilyNames, sanitizeBundledSelection, deriveBundledActivationForConfig, } from './font-offerings.js';
export type { DocumentFontOption, FontFamilyOption } from './document-font-options.js';
export { buildDocumentFontOptions, buildFontFamilyOptions } from './document-font-options.js';
export type { FaceSlot as FontFaceSlot, GlyphException, SubstitutePolicyAction, SubstituteVerdict, } from './substitution-evidence.js';
