import type { FontFaceDescriptor, FontFaceLoadResult, FontFaceRequest, FontLoadResult, FontLoadStatus, RegisteredFace, RegisterFaceResult, RequiredFace } from './types.js';
/**
 ...
 */
export declare const DEFAULT_FONT_LOAD_TIMEOUT_MS = 3000;
/**
...
export type FontFaceCtor = new (family: string, source: string | ArrayBuffer | ArrayBufferView, descriptors?: FontFaceDescriptors) => FontFaceLike;
/**
...
export declare class FontRegistry {
     ...
     */
    awaitFace(family: string, timeoutMs?: number): Promise<FontLoadResult>;
    /**
     ...
     */
    awaitFaces(families: Iterable<string>, options?: {
        timeoutMs?: number;
     ...
     * loads (idempotently).
     */
    getRequiredFaces(families: Iterable<string>, timeoutMs?: number): RequiredFace[];
     ...
     */
    awaitFaceRequest(request: FontFaceRequest, timeoutMs?: number): Promise<FontFaceLoadResult>;
    /** Await many faces; result preserves input order after de-duplication by face key. */
    awaitFaceRequests(requests: Iterable<FontFaceRequest>, options?: {
        timeoutMs?: number;
 ...
 */
export declare function getFontRegistryFor(fontSet: FontSetLike | null, FontFaceCtor: FontFaceCtor | null): FontRegistry;
/**
 ...
 */
export declare function getDefaultFontRegistry(): FontRegistry;
