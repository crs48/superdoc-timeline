 ...
 * compatibility).
 */
import { type BundledActivation } from './activation.js';
...
export declare class FontResolver {
    #private;
    constructor(activation?: BundledActivation);
    /**
 ...
 */
export declare function createFontResolver(activation?: BundledActivation): FontResolver;
export declare function resolveFontFamily(logicalFamily: string): FontResolution;
export declare function resolvePhysicalFamily(cssFontFamily: string): string;
export declare function resolvePrimaryPhysicalFamily(family: string): string;
export declare function resolvePhysicalFamilies(families: Iterable<string>): string[];
export declare function resolveFace(logicalFamily: string, face: FaceKey, hasFace: HasFace): FontResolution;
/**
 ...
 */
export declare const DEFAULT_FONT_MEASURE_CONTEXT: FontMeasureContext;
