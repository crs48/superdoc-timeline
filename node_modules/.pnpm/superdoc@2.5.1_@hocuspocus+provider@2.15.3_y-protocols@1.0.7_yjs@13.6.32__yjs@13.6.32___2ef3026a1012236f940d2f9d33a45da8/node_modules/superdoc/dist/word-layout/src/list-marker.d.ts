import { NumberingManager } from './numbering-manager.js';
import { ListRenderingAttrs } from './types.js';
 ...
 */
export declare function computeWordListMarker(input: ComputeWordListMarkerInput): ComputeWordListMarkerResult;
