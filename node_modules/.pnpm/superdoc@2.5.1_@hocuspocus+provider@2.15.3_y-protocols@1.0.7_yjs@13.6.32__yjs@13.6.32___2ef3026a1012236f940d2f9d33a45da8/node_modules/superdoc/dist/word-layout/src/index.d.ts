import { WordParagraphLayoutInput, WordParagraphLayoutOutput } from './types.js';
export * from './types.js';
export { TWIPS_PER_PIXEL, PIXELS_PER_TWIP, TWIPS_PER_POINT, POINTS_PER_TWIP, pixelsToTwips, twipsToPixels, pointsToTwips, twipsToPoints, halfPointsToPoints, pointsToHalfPoints, } from './unit-conversions.js';
 ...
 * ```
 */
export declare function computeWordParagraphLayout(input: WordParagraphLayoutInput): WordParagraphLayoutOutput;
