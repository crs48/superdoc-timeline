...
.superdoc[data-v-af3574db] {
  display: flex;
  position: relative;
}
.sd-visually-hidden[data-v-af3574db] {
  position: absolute;
  width: 1px;
  height: 1px;
  padding: 0;
...
.right-sidebar[data-v-af3574db] {
  min-width: 320px;
  height: 100%;
}
.floating-comments[data-v-af3574db] {
  min-width: 300px;
  width: 300px;
  height: 100%;
  overflow: visible;
}
.superdoc__layers[data-v-af3574db] {
  height: 100%;
  position: relative;
  box-sizing: border-box;
}
.superdoc__document[data-v-af3574db] {
  width: 100%;
  position: relative;
}
.superdoc__sub-document[data-v-af3574db] {
  width: 100%;
  position: relative;
}
.superdoc__selection-layer[data-v-af3574db] {
  position: absolute;
  min-width: 100%;
  min-height: 100%;
  z-index: 10;
...
.superdoc__whiteboard-layer[data-v-af3574db] {
  z-index: 4;
}
.superdoc__temp-selection[data-v-af3574db] {
  position: absolute;
}
.superdoc__right-sidebar[data-v-af3574db] {
  width: 320px;
  min-width: 320px;
  padding: 0 10px;
  min-height: 100%;
...
.superdoc__compact-comment-popover[data-v-af3574db] {
  position: absolute;
  top: 12px;
  right: 12px;
  z-index: 11;
...
.tools-item i[data-v-af3574db] {
  cursor: pointer;
}
.superdoc__tools-icon[data-v-af3574db] {
...
.superdoc .superdoc__layers[data-v-af3574db] {
    margin: 0;
    border: 0 !important;
    box-shadow: none;
}
...
/* AI Writer styles */
.ai-writer-container[data-v-af3574db] {
  position: fixed;
  z-index: 1000;
  background: white;
  border-radius: 8px;
...
.ai-tool > svg[data-v-af3574db] {
  fill: transparent;
}
.ai-tool[data-v-af3574db]::before {
  content: '';
  position: absolute;
  width: 20px;
  height: 20px;
...
.ai-tool[data-v-af3574db]:hover::before {
