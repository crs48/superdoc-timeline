 ...
 */
export declare const SPACE_CHARS: Set<string>;
/**
 ...
 */
export declare function shouldApplyJustify(params: ShouldApplyJustifyParams): boolean;
/**
 ...
 */
export declare function getFirstLineIndentOffset(indent: {
    firstLine?: number;
    hanging?: number;
} | undefined, suppressFirstLineIndent: boolean): number;
/**
 ...
 */
export declare function adjustAvailableWidthForTextIndent(availableWidth: number, textIndentOffset: number, lineMaxWidth: number | null | undefined): number;
export declare function calculateJustifySpacing(params: CalculateJustifySpacingParams): number;
