import { FlowBlock, TrackChangeAuthor, TrackedChangeMeta } from './index.js';
/**
 ...
 * cells.
 */
export type TrackedChangeSemanticColorKey = 'insertion' | 'deletion' | 'move' | 'move-from' | 'move-to' | 'table-insertion' | 'table-deletion' | 'table-row-insertion' | 'table-row-deletion' | 'table-cell-insertion' | 'table-cell-deletion' | 'table-split' | 'cell-merge' | 'cell-split' | 'image-insertion' | 'image-deletion' | 'image-property-change';
/**
 ...
 */
export type TrackedChangeConfigurableSemanticColorKey = 'insertion' | 'deletion' | 'move' | 'move-from' | 'move-to' | 'table-cell-insertion' | 'table-cell-deletion' | 'cell-merge' | 'cell-split' | 'image-insertion' | 'image-deletion' | 'image-property-change';
/** All semantic color keys, in declaration order (useful for iteration/tests). */
export declare const TRACKED_CHANGE_SEMANTIC_COLOR_KEYS: readonly TrackedChangeSemanticColorKey[];
/** The JS-configurable subset, in declaration order. */
export declare const TRACKED_CHANGE_CONFIGURABLE_SEMANTIC_COLOR_KEYS: readonly TrackedChangeConfigurableSemanticColorKey[];
/** Whether a category resolves its color through the JS `semanticColors` config. */
export declare const isConfigurableSemanticColorKey: (key: TrackedChangeSemanticColorKey | null | undefined) => key is TrackedChangeConfigurableSemanticColorKey;
/**
 ...
 */
export declare const DEFAULT_TRACKED_CHANGE_SEMANTIC_COLORS: Readonly<Record<TrackedChangeConfigurableSemanticColorKey, string>>;
 ...
 */
export declare const trackedChangeMetaSignature: (trackedChange: TrackedChangeMeta | null | undefined) => string;
export declare const trackedChangeLayersSignature: (trackedChanges: readonly TrackedChangeMeta[] | null | undefined) => string;
/** Default semantic color for a JS-configurable key, or `undefined` for an unknown/CSS-only key. */
export declare const defaultSemanticColor: (key: TrackedChangeSemanticColorKey) => string | undefined;
 ...
 */
export declare const TRACKED_CHANGE_SEMANTIC_TARGET_KINDS: Readonly<Record<TrackedChangeSemanticColorKey, TrackedChangeSemanticTargetKind>>;
/** Target kind for a semantic key, or `undefined` for an unknown/absent key. */
export declare const semanticColorTargetKind: (key: TrackedChangeSemanticColorKey | null | undefined) => TrackedChangeSemanticTargetKind | undefined;
/**
 ...
 */
export declare const TRACKED_CHANGE_AFFECTED_RANGE_KEYS: ReadonlySet<TrackedChangeSemanticColorKey>;
/** Anchor scope for a semantic key: `'affected-range'` for range paints, else `null`. */
export declare const semanticColorAnchorScope: (key: TrackedChangeSemanticColorKey | null | undefined) => "affected-range" | null;
/**
 ...
 */
export declare const structuralSemanticColorKey: (kind: string | null | undefined, targetKind: "table" | "row" | "cell" | "image") => TrackedChangeSemanticColorKey | undefined;
/**
 ...
 * default color.
 */
export declare const composeSemanticColorResolver: (config?: SemanticColorsConfig | null) => TrackChangeSemanticColorResolver | undefined;
/**
 ...
 */
export declare const stampTrackedChangeSemanticColors: (blocks: FlowBlock[], resolve: TrackChangeSemanticColorResolver | undefined) => void;
