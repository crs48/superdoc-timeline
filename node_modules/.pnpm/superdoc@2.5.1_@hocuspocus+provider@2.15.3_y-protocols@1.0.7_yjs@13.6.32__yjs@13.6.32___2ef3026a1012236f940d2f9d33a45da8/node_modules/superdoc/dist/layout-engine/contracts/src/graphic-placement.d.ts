...
export declare function isPagePositionedParagraphFrame(frame: {
    wrap?: string;
    vAnchor?: string;
    y?: number;
} | undefined): frame is {
 ...
 */
export declare function resolveFooterPageFrameOriginY(pageHeight: number, bottomMargin?: number): number;
