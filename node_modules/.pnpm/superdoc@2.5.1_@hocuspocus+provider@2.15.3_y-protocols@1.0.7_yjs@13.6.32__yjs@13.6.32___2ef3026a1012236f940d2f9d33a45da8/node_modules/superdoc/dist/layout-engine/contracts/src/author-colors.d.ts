...
export declare const authorIdentityKey: (author: TrackChangeAuthor | undefined) => string;
/**
 ...
 */
export declare const fallbackAuthorColor: (author: TrackChangeAuthor | undefined) => string;
/**
 ...
 */
export declare const composeAuthorColorResolver: (config?: AuthorColorsConfig | null) => TrackChangeAuthorColorResolver | undefined;
/** Maps tracked-change metadata to the author identity the resolver expects. */
export declare const authorFromTrackedChangeMeta: (meta: TrackedChangeMeta) => TrackChangeAuthor;
/**
 ...
 */
export declare const stampTrackedChangeColors: (blocks: FlowBlock[], resolve: TrackChangeAuthorColorResolver | undefined) => void;
