 ...
 */
/**
 * Dist-only Node build input for `superdoc/collaboration-upgrade-engine`.
 *
 * The customer-facing `superdoc` package bundles this implementation into its
 * own public subpath. Internal v2 packages and types must not escape through
 * this contract.
 */
export declare const COLLABORATION_UPGRADE_ENGINE_PROTOCOL_VERSION: 1;
export declare const SUPPORTED_COLLABORATION_UPGRADE_BUNDLE_VERSIONS: readonly [1];
export declare const SUPPORTED_V1_READER_CONTRACT_VERSIONS: readonly [1];
export declare const COLLABORATION_UPGRADE_ENGINE_MINIMUM_NODE_MAJOR: 20;
...
export declare function getCollaborationUpgradeEngineInfo(): CollaborationUpgradeEngineInfo;
export declare function buildV2CollaborationUpgradeArtifactFromBundle(input: BuildV2CollaborationUpgradeArtifactFromBundleInput): Promise<CompleteV2CollaborationUpgradeArtifact>;
export declare function validateV2CollaborationUpgradeTarget(input: ValidateV2CollaborationUpgradeTargetInput): Promise<V2CollaborationUpgradeTargetValidation>;
